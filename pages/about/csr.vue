<template>
   <div id="csr" :class="['page', $store.state.ww.size]">
     ...
     <HeroImage pos="-2%" :word="['To spread', 'Charm']" />

     <Heading
       type="three-way"
       align="left"
       :title="['Our', 'Approach']"
       :subtitle="['ブルガリアンローズの魅力を多くのかたへ']"
       :message="[
    ...
    type="pale"
    title="KOUGAKU"
    :subtitle="['香り創りによる', '情操教育を実施']"
    />
    <section class="kougaku">
      <h1 class="section-heading">「香楽KOUGAKU」</h1>
      <p>
